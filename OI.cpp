...
OI::OI() {
	...
	stopButton = new JoystickButton(driveJoystick, 2);
	stopButton->WhenPressed(new StopShooter());
	startButton = new JoystickButton(driveJoystick, 1);
	startButton->WhenPressed(new StartShooter());
